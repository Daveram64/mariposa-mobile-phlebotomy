...
| New: price discrepancy | `CONFIRM(Dave Q20)` added. The live `/pricing` page (updated 2026-07-02) lists the standard draw at **$175**, autism-informed draws at a flat **$200**, fertility/surrogate draws at $150 and care-facility visits at $175. This site says $200 standard and a +$25 autism add-on, and has no fertility or facility line. One of the two sites is wrong; decide, then fix every price in one pass (homepage table, pricing page, llms.txt, both FAQ schemas, the athlete page "standard $200 draw" line). |
